...
namespace pos {
    ...
    using v8::Value;
        ...
        int cursor_position(int *const rowptr, int *const colptr)
        {
            ...
            // Success!
            if (rowptr) *rowptr = console_info.dwCursorPosition.Y + 1;
            if (colptr) *colptr = console_info.dwCursorPosition.X + 1;
        ...
        int cursor_position(int *const rowptr, int *const colptr)
        {
            ...
            */
            do {
                ...
                /* Success! */
                if (rowptr) *rowptr = rows;
                if (colptr) *colptr = cols;
            ...
            if (result == -1 && !retval) retval = errno;
    ...
    void Method(const FunctionCallbackInfo<Value>& args) {
        ...
        if (cursor_position(&row, &col)) return;
    ...
    void Init(Local<Object> exports) {
        NODE_SET_METHOD(exports, "sync", Method);
    }

    NODE_MODULE(pos, Init)
}
